...
This AWS Lambda function is part of [Mapping Prejudice's](https://mappingprejudice.umn.edu/) Deed Machine application. This component receives data about a page that has been flagged as a match, then uses the match data and OCR JSON to create a version of the web-friendly image with a visible highliht. This is the final Lambda in the Deed Machine initial processing Step Function.
